...
- `models/qwen3.5-35b-a3b-fp8`: `Qwen/Qwen3.5-35B-A3B-FP8` flow (persistent download + FP8/tool-calling/MTP serve configuration).
- `models/qwen3.5-122b-a10b-gptq-int4`: `Qwen/Qwen3.5-122B-A10B-GPTQ-Int4` flow (persistent download + GPTQ/tool-calling/MTP serve configuration).
